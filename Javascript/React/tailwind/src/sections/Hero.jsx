...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      w-full max-xl:padding-x pt-28">
        ...
        max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          ...
          xl:whitespace-nowrap relative z-10 pr-10">
            The New Arrrival <br/></span>
          <span className="text-coral-red inline-block my-6
          ">Nike</span> Shoes
      ...
      xl:min-h-screen max-xl:py-10 bg-primary bg-hero
      bg-cover bg-center">
        <img src={bigShoeImg} alt="shoe collection" 
        width={610} 
        height={500}
        className="object-contain relative z-10"/>
        <div className="flex sm:gap-6 gap-4 absolute -bottom-[7%] sm:-bottom-[18%]
