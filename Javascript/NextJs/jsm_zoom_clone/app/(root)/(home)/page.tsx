...
const Home = () => {
  ...
  // const time = `${now.getHours() > 12 ? now.getHours()-12 : now.getHours()}:${now.getMinutes()} ${now.getHours() > 12 ? "PM" : "AM"}`
  ...
  useEffect(() => {
    ...
    const intervalID = setInterval(updateTime, 50000);
      ...
      <div className='h-[300px] w-full rounded-[20px] bg-cover bg-hero'>
        ...
        max-md:px-5 max-md:py-8 lg:p-11">
         <h2 className='glassmorphism max-w-[270px] rounded 
          py-2 text-center text-base font-normal'> Upcoming Meeting at: 12:30
            </h2>
